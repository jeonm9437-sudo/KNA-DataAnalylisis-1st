...
# input을 통해 사용자에게 값을 입력받는 경우는 무조건 "str 타임"
...
# 시도 3. 가이드 문구에 규칙과 함께 입력 받아야 하는 값을 출력
input("이름, 나이를 입력해주세요. (ex. Miso, 20): ")
...
print("이름:", name, "나이:", age)  # 이름: Miso, 나이 : 20

# ======================
# 실습, 이름 입력받아 인사 출력하기
print("=== 실습, 이름 입력받아 인사 출력하기 ===")
...
# input을 통해 사용자 입력값으로 받은
# 문자열을 매개변수로 받은 int 함수를 통해
# int(정수형)으로 자료형이 바뀜
# 그 다음에 age라는 변수에 값이 할당
# print("사용자 입력값을 int 변환한 age 변수의 자료형:", type(age))
# print("당신은 곧", age + 1, "세가 됩니다.")

# 사용자 입력을 int로 변환하지 못하는 값을 입력할 경우
print(int("123"))  # 123
# print(int("010-1234-5678"))  # ValueError
# -는 숫자가 아니기 때문에 int로 변환할 수 업음

# ====================
print("=== 실습, 태어난 해 입력받아 나이 구하기 ===")
