# while은 특정 조건(횟수X)이 False가 될 때까지
# 반복해야 하는 경우 사용
...
# while count >= 1:  # 2번
#     count = 0
#     # 반복문 안에 count 변수를 계속 0으로 재할당해서 무한루프에 빠짐
#     print(count)
#     count += 1  # 3번
...
# 예 2) 사용자 입력값을 누적하다가 누적값이 총 15을 넘으면
# 종료하고 싶을 때
...
# 첫 번째 입력값은 자동으로 최대값이 됨 (비교할 다른 값이 없기 때문)
max_value = first
