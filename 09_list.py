...
print("=== 실습2 ===")
print(temps[0], temps[2], temps[-1])

print("=== 실습3 ===")
line = [30, 45, 60, 88, 61, 23]
a = line[0]
b = line[-1]
print(a + b)
print((a + b) / 2)
...
# temps 라는 리스트의 0번째 인덱스 요소
print(f"type(temps[0]: {temps[0]}")  # 35
...
# 슬라이싱 temps[0]은 리스트([35, 36])
# 슬라이싱은 영역을 잘라내는 역할이기 때문에 리스트를 반환하는 것
# temps[100:999] 에러 발생하지 않음
# 슬라이싱은 '있는 만큼만' 잘라주기 때문에 애러 발생하지 않음

print("=== 실습 4 ===")
# 실습 4
# temps = [22, 12, 36, 45, 48, 53, 57, 64, 68, 75]
# print(temps[:3])
# print(temps[-3:])
# print(len(temps[:3]))
...
# .index() 메서드는 리스트의 가장 처음 등장하는 인덱스만 반환
...
# 삭제한 인덱스의 값을 반환
list1.pop(0)
print(list1)  # 235번줄 pop 결과물 확인 용도
...
del list2[100:300]  # 슬라이싱 할 값이 없기 때문에 그대로 유지 > Error가 나지 않음
print(list2)
...
# .reverse()
# 정렬은 해주지 않음
# 뒤로 계속 쌓인 결과(최신)을 앞에서부터 보고싶을 때 사용
