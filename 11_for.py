...
for i in range(0, 10, -2):
    print(i)
# 동작 안함
# 시작값인 0에서 -2를 했을 때 끝 값이 포함되지 않아서 그대로 반복문 종료
...
for i in range(1, num + 1):
    if i % 3 == 0:
        print(f"입력한 1~{num}사이의 3의 배수 출력: {i}")
    elif i % 5 == 0:
        print(f"입력한 1~{num}사이의 5의 배수 출력: {i}")
    # 15와 같이 3의 배수이면서 5의 배수인 경우는 3의 배수라고만 출력


print(3 % 3)
# 0 > 사과 3개를 3개의 봉지에 균등히 나눠담으면(각 1개씩)
# 못 담는 사과는 0개
print(4 % 3)
# 1 > 사과 4개를 3개의 봉지에 균등히 나눠담으면(각 1개씩)
# 못 담는 사과는 1개
print(5 % 3)
# 2 > 사과 5개를 3개의 봉지에 균등히 나눠담으면(각 1개씩)
# 못 담는 사과는 2개
print(6 % 3)
# 0 > 사과 4개를 3개의 봉지에 균등히 나눠담으면(각 )
